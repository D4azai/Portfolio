export const pages = {
  ...
  about: { path: '/about', label: 'About', title: 'The people behind the systems — AYNKO', description: 'Meet Aymane Chellak and Zakaria Bak and explore four animated 3D scenes about how we understand, architect, build, and evolve software.' },
